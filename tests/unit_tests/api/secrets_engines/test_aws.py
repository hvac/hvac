...
class TestAws(TestCase):
    ...
    def test_configure_root_iam_credentials(self, test_label, requests_mocker):
    ...
    @requests_mock.Mocker()
    def test_rotate_root_iam_credentials(self, test_label, requests_mocker):
        raise NotImplementedError
    ...
    @requests_mock.Mocker()
    def test_configure_lease(self, test_label, requests_mocker):
        raise NotImplementedError
    ...
    @requests_mock.Mocker()
    def test_read_lease(self, test_label, requests_mocker):
        raise NotImplementedError
    ...
    @requests_mock.Mocker()
    def test_create_or_update_role(self, test_label, requests_mocker):
        raise NotImplementedError
