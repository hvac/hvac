...
class Gcp(VaultApiBase):
    ...
    def create_or_update_roleset(self, name, project, bindings, secret_type='access_token', token_scopes=None,
        ...
        api_path = utils.format_url('/v1/{mount_point}/roleset/{name}',
    ...
    def rotate_roleset_account(self, name, mount_point=DEFAULT_MOUNT_POINT):
        ...
        :rtype: requests.Response
        """
        api_path = utils.format_url('/v1/{mount_point}/roleset/{name}/rotate',
            mount_point=mount_point,
            name=name,
        )
        return self._adapter.post(
    ...
    def rotate_roleset_account_key(self, name, mount_point=DEFAULT_MOUNT_POINT):
        ...
        :rtype: requests.Response
        """
        api_path = utils.format_url('/v1/{mount_point}/roleset/{name}/rotate-key',
            mount_point=mount_point,
            name=name
        )
        return self._adapter.post(
    ...
    def generate_oauth2_access_token(self, roleset, mount_point=DEFAULT_MOUNT_POINT):
        ...
        :rtype: dict
        """
        api_path = utils.format_url('/v1/{mount_point}/token/{roleset}',
            mount_point=mount_point,
            roleset=roleset,
        )
        response = self._adapter.get(
    ...
    def generate_service_account_key(self, roleset, key_algorithm='KEY_ALG_RSA_2048',
        ...
        :rtype: dict
        """
        api_path = utils.format_url('/v1/{mount_point}/key/{roleset}',
            mount_point=mount_point,
            roleset=roleset,
        )
