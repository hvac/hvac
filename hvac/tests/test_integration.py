...
class IntegrationTest(TestCase):
    ...
    def test_auth_kubernetes_alternate_mount_point_with_no_client_token_exception(self):
        test_mount_point = 'kube-custom-path'
        ...
        # generic 'missing client token' response from Vault.
        with self.assertRaises(exceptions.InvalidRequest) as assertRaisesContext:
            self.client.auth_kubernetes('example-role', jwt)
